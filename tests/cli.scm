...
(test-equal "command-print: a complex object"
  "BEGIN: VCALENDAR
    ...
    BEGIN: VEVENT
        ...
        DTSTART (DATE-TIME);TZID=Europe/Berlin: 20250115T160000
        DTEND (DATE-TIME);TZID=Europe/Berlin: 20250115T170000
        DTSTAMP (DATE-TIME): 20241220T164610
    ...
    BEGIN: VTIMEZONE
        ...
        BEGIN: DAYLIGHT
            DTSTART (DATE-TIME): 20250330T030000
            TZNAME (TEXT): CEST
            TZOFFSETFROM (UTC-OFFSET): +0100
            TZOFFSETTO (UTC-OFFSET): +0200
        END: DAYLIGHT
        BEGIN: STANDARD
            DTSTART (DATE-TIME): 20241027T020000
            TZNAME (TEXT): CET
